package com.app.graham.partner.multipart;
...
import com.app.graham.partner.utils.LruBitmapCache;
    ...
    private VolleySingleton(Context context) {
        ...
        mImageLoader = new ImageLoader(mRequestQueue,
                new ImageLoader.ImageCache() {
                    private final LruCache<String, Bitmap> cache = new LruBitmapCache(1000000);
