...
class SubCategoriesCustomAdapter (val context: Context, var categorieslist: List<SubCategoriesListPozo>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        vh.label.text = categorieslist.get(position).tittle
        return view
    }
