...
import com.app.graham.partner.BuildConfig;
...
public class CameraUtil {
   ...
   //     File mediaStorageDir = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES), "/demonuts");

        // Create the storage directory if it does not exist
        if (!mediaStorageDir.exists()) {
            if (!mediaStorageDir.mkdirs()) {
                Log.e("/demonuts", "Oops! Failed create "
                        + "/demonuts" + " directory");
                return null;
            }
        }
